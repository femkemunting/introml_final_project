...
* Picking the folds is unnecessary if we leave indexOut empty in trainControl()
``` {r Popularity Model Set-Up}

model_data <- filtered_spotify[ , c("popularity", "duration_ms", "danceability", "energy", "key", "loudness", "mode", "speechiness", "acousticness", "instrumentalness", "liveness", "valence", "tempo")]
...
spotify_gbm_grid <-  expand.grid(interaction.depth = c(1, 2, 3, 5, 10), 
                        n.trees = c(150, 500, 1000), 
                        shrinkage = c(0.01, 0.1, 0.2, 0.5),
                        n.minobsinnode = 10)
